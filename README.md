...
[8B. Проверка на неориентированность](https://github.com/mrskycriper/itmo.algorithms.sem02/blob/master/lab08/8B.cpp)

[8C. Проверка на наличие параллельных рёбер, неориентированный граф](https://github.com/mrskycriper/itmo.algorithms.sem02/blob/master/lab08/8C.cpp)

[8D. Компоненты связности](https://github.com/mrskycriper/itmo.algorithms.sem02/blob/master/lab08/8D.cpp)
...
# lab09 [Tasks text](https://github.com/mrskycriper/itmo.algorithms.sem02/blob/master/lab09/problems9.pdf)
